...
public class HttpUtils {
     ...
     *
     * @param url          请求地址
     * @param formDataText form-data 文本
     * @param formDataFile form-data 文件
     * @param headers      请求头
     * @return
     */
    public static String postFormData(String url, Map<String, String> formDataText, Map<String, String> headers, Map<String, File> formDataFile) throws Exception {
        ...
        if (formDataText != null) {
            formDataText.forEach(builder::addTextBody);
        }
        //文件
        if (formDataFile != null) {
            formDataFile.forEach(builder::addBinaryBody);
        }
