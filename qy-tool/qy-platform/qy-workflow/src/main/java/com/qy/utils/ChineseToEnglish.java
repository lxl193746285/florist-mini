...
public class ChineseToEnglish {
    // 将汉字转换为全拼
    public static String getPingYinToUpperCase(String src) {
        char[] t1 = null;
        t1 = src.toCharArray();
...
//	        System.out.println(getPingYinToUpperCase("綦江qq县"));  
//	        System.out.println(getPinYinHeadChar("綦江县"));  
//	        System.out.println(getPinYinHeadCharToUpperCase("綦江县"));  
