 ...
 */
@Data
public class DefNodeFormNodeDTO implements Serializable {
     ...
     * 打回节点配置
     */
    @ApiModelProperty(value = "打回节点配置")
    private List<DefNodeRepulseFormDTO> nodeRepulseFormDTOList = new ArrayList<>();
